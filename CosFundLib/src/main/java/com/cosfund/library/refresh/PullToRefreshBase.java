 ...
 *******************************************************************************/
package com.cosfund.library.refresh;
...
import com.cosfund.library.refresh.internal.FlipLoadingLayout;
import com.cosfund.library.refresh.internal.LoadingLayout;
import com.cosfund.library.refresh.internal.RotateLoadingLayout;
import com.cosfund.library.refresh.internal.Utils;
import com.cosfund.library.refresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private boolean mAutoUpdateLastLabel = true;
	...
	private void callRefreshListener() {
		...
		if(update > 0){
			...
			switch (update) {
				case 1: getLoadingLayoutProxy().setLastUpdatedLabel(label); return;
				case 2: mHeaderLayout.setLastUpdatedLabel(label); return;
				case 3: mFooterLayout.setLastUpdatedLabel(label); return;
			}
		}
	}
...
//		mFooterLayout.setLastUpdatedLabel(label);
	...
	public void setAutoUpdateLastLabel(boolean isAutoUpdateLastLabel){
		this.mAutoUpdateLastLabel = isAutoUpdateLastLabel;
	}
	...
	public void setHeaderTextColor(int color){
		...
		if(mFooterLayout != null){
			mFooterLayout.setHeaderTextColor(color);
		}
	}
	public void setSubHeaderTextColor(int color){
		if(mHeaderLayout != null){
			mHeaderLayout.setSubHeaderTextColor(color);
		}
		if(mFooterLayout != null){
			mFooterLayout.setSubHeaderTextColor(color);
		}
	}
	/**
	 * 设置标题字体大小
	 * @param size
	 */
	public final void setHeaderTextSize(float size){
		mHeaderLayout.setHeaderTextSize(size);
		mFooterLayout.setHeaderTextSize(size);
	}
	/**
	 * 设置副标题字体大小
	 * @param size
	 */
	public final void setSubHeaderTextSize(float size){
		mHeaderLayout.setSubHeaderTextSize(size);
		mFooterLayout.setSubHeaderTextSize(size);
	}
