package com.cosfund.library.dialog;
...
public class HintDialog {
    ...
    public HintDialog setView(View view) {
        mView = view;
        if (mBuilder != null) {
    ...
    public HintDialog setContentView(View view) {
     ...
     */
    public HintDialog setContentView(int layoutResId) {
    ...
    public HintDialog setBackground(Drawable drawable) {
    ...
    public HintDialog setBackgroundResource(int resId) {
    ...
    public HintDialog setTitle(int resId) {
        mTitleResId = resId;
        if (mBuilder != null) {
    ...
    public HintDialog setTitle(CharSequence title) {
        mTitle = title;
        if (mBuilder != null) {
    ...
    public HintDialog setMessage(int resId) {
        mMessageResId = resId;
        if (mBuilder != null) {
    ...
    public HintDialog setMessage(CharSequence message) {
        mMessage = message;
        if (mBuilder != null) {
    ...
    public HintDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        this.pId = resId;
    ...
    public HintDialog setPositiveButton(String text, final View.OnClickListener listener) {
        this.pText = text;
        this.pListener = listener;
        return this;
    }

    public HintDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        this.nId = resId;
        this.nListener = listener;
        return this;
    }

    public HintDialog setNegativeButton(String text, final View.OnClickListener listener) {
        this.nText = text;
        this.nListener = listener;
        return this;
    }

    public HintDialog setCanceledOnTouchOutside(boolean cancel) {
        this.mCancel = cancel;
        if (mBuilder != null) {
    ...
    public HintDialog setOnDismissListener(DialogInterface.OnDismissListener onDismissListener) {
    ...
    private class Builder {
        ...
        /**
         * 设置一个自定义视图对话框的内容资源。 这个资源 ScrollView.
         *
